#' @name    gvcR
#' @aliases gvcR
#' @title   Genotypic Variance Components with R
#' @description Functionalities to compute model based genetic
#' components i.e genotypic, phenotypic variances and heritability
